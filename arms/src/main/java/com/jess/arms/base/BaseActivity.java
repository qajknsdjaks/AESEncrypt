 ...
 * ================================================
 */
public abstract class BaseActivity<P extends IPresenter> extends AppCompatActivity implements ISupportActivity,IActivity, ActivityLifecycleable {
    protected final String TAG = this.getClass().getSimpleName();
    private final BehaviorSubject<ActivityEvent> mLifecycleSubject = BehaviorSubject.create();
    @Inject
    @Nullable
    protected P mPresenter;//如果当前页面逻辑简单, Presenter 可以为 null
    protected GISLoadingDlg loadingDialog;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        loadingDialog = new GISLoadingDlg(BaseActivity.this);
